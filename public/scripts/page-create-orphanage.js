// create map
const map = L.map('mapid').setView([-21.7810901,-48.1819913], 14);
...
map.on('click', (event) => { // Dessa forma é a mesma coisa que fazer: map.on('click', function ({ 
...
function addField() {
    ...
    // pegar o container para clonar .new-upload
